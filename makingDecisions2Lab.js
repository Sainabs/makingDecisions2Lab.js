...
/*
  ...
  Console.log the array to verify you no longer have 
  the last item.
*/
//Code Here
...
/*
  ...
  if the number is even, append(means add to) it to the 'evensArr'.
*/
...
/*
  ...
  between 60 and 69, 'D', and anything below 60 should 
  console log an 'F'.
*/
...
// Do not edit the code below.
var myFavoriteNumbers = [4,8,12,16,20,24, 40, 50];
// Do not edit the code above.
...
// Subscripting (accessing values using their index) an array
// can fail. What happens if you subscript to the 7th element, 
//but there are not 7 elements in the array? Let's write some code
// to check for that. 
...
//7th element in the array. (Hint: how can you make sure that your code works for exactly
...
//checking to see if each number is divisible by 3. 
